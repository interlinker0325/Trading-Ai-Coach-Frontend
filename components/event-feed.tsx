...
export function EventFeed({ plan }: EventFeedProps) {
      ...
      const mockEvents: MarketEvent[] = [
        {
          ...
          description: "CEO Tim Cook purchased $2.5M worth of shares at $185.42",
        ...
        },
        {
          ...
          description: "10,000 call options bought at $240 strike, expiring Friday",
        ...
        },
        {
          ...
          symbol: "NVDA",
          title: "Earnings Beat",
          description: "Q4 earnings beat expectations by 15%, revenue up 22% YoY",
        ...
        },
        {
          ...
          description: "EUR/USD breaking above key resistance at 1.0850 with high volume",
        ...
        },
        {
          ...
          description: "Gold volatility increased 45% following Fed announcement",
        ...
        },
        {
          ...
          description: "50,000 ETH moved to Binance, potential selling pressure",
          timestamp: new Date(Date.now() - 30 * 60 * 1000),
          severity: "medium",
          premium: true,
          data: { amount: 50000, exchange: "Binance", direction: "to_exchange" },
        },
      ]
      return mockEvents
    }
  ...
  const displayEvents = plan === "free" ? filteredEvents.filter((event) => !event.premium).slice(0, 3) : filteredEvents
      ...
      <CardHeader>
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-muted-foreground">Real-time market events across all asset classes</p>
          </div>
            ...
            {loading ? (
              ...
              <div className="space-y-3 pb-4">
                {displayEvents.map((event) => (
                  <Alert
                    key={event.id}
                    className={`${getSeverityColor(event.severity)} transition-all hover:shadow-sm`}
                  >
                    <div className="flex items-start space-x-3">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center justify-between mb-1">
                          <div className="flex items-center space-x-2">
                            <Badge variant="outline" className={`text-xs ${getAssetTypeColor(event.assetType)}`}>
                              {event.symbol}
                            </Badge>
