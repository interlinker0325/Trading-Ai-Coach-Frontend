...
export default function ChartsPage() {
  ...
  const [selectedAssetType, setSelectedAssetType] = useState<"stocks" | "crypto" | "forex" | "commodities">("stocks")
  ...
  const popularSymbols = {
    ...
    commodities: ["Gold", "Silver", "Oil", "Natural Gas", "Copper", "Platinum", "Palladium", "Wheat"],
  }
    ...
    <div className="container mx-auto p-6 space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">TradingView-style charting with technical analysis</p>
        </div>
      </div>
      ...
      <Card>
        ...
        <CardContent>
          ...
          <Tabs value={selectedAssetType} onValueChange={(value: any) => setSelectedAssetType(value)}>
      ...
      <AdvancedChart symbol={selectedSymbol} assetType={selectedAssetType} plan={plan} />
    </div>
  )
}
